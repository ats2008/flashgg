...
flashggTrippleHTag = cms.EDProducer("FlashggTrippleHTagProducer",
                                   ...
                                   GenJetTag = cms.InputTag( "slimmedGenJets" ), # to compute MC-truth info
...
cfgTools.addVariables(flashggTrippleHTag.MVAConfig.variables,
