...
class TrippleHTagProducer : public EDProducer
{

public:
    TrippleHTagProducer( const ParameterSet & );
private:
...
int TrippleHTagProducer::chooseCategory( float mvavalue, float mxvalue)
{
...
bool TrippleHTagProducer::isclose(double a, double b, double rel_tol=1e-09, double abs_tol=0.0)
{
...
float TrippleHTagProducer::EvaluateNN()
{
...
typedef flashgg::TrippleHTagProducer FlashggTrippleHTagProducer;
DEFINE_FWK_MODULE( FlashggTrippleHTagProducer );
// Local Variables:
// mode:c++
